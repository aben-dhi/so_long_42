...
/*   Updated: 2023/05/08 20:34:45 by aben-dhi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->image.len = (game->columns) * 32;
	game->image.wid = game->rows * 32;
	if (game->image.len > 5120 || game->image.wid > 1440
		|| (game->image.len > 5120 && game->image.wid > 1440))
	{
		write (2, "Error\nmap too big\n", 19);
		exit (1);
	}
